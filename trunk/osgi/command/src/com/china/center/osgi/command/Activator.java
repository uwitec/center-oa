...
public class Activator implements BundleActivator, CommandProvider
{
    ...
    public void _uname(CommandInterpreter intp) throws Exception
    {
     ...
     * @throws Exception 
     */
    public void _env(CommandInterpreter intp) throws Exception
    {
    ...
    public void _whatami(CommandInterpreter intp) throws Exception
    {
        try
        {
    ...
    public void _grep(CommandInterpreter intp) throws Exception
    {
        _f(intp);
    }
     ...
     * @throws Exception 
     */
    public void _f(CommandInterpreter intp) throws Exception
    {
        ...
        else
        {
            ...
            for (int i = 0; i < bundles.length; i++)
            {
                ...
                String allStr = String.valueOf(bundles[i].getBundleId())
                        + bundles[i].getSymbolicName() + version
