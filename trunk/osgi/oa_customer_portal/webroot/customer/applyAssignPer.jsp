...
function selectCus()
{
    window.common.modal('../customer/customer.do?method=rptQueryAllCustomer&load=1&view=1');
}
...
function getCustomer(obj)
{
    ...
    $O('oassignPer1').value = obj.passignPer1;
    $O('oassignPer2').value = obj.passignPer2;
    $O('oassignPer3').value = obj.passignPer3;
    $O('oassignPer4').value = obj.passignPer4;
}
