...
<form name="formEntry" action="../make/make.do" method="post"><input
	type="hidden" name="method" value="updateMake01">
...
<p:navigation
	...
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">定制产品管理</span> &gt;&gt; 修改定制产品(第一环)</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:title>
		<td class="caption"><strong>定制产品基本信息(第一环)：(只可以上传office文字附件，任何含有图片的文件不能传输，需转为QQ传递)</strong></td>
	</p:title>
	...
	<p:subBody width="98%">
		...
		<p:table cells="1">
		    ...
		    <p:cell title="类型">
              <select class="select_class" name="type" values="${make.type}" readonly="true">
