...
<form name="formEntry" action="../worklog/worklog.do" method="post"><input
    ...
    type="hidden" name="update" value="0"> <p:navigation
	height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javaScript:window.history.go(-1);">工作日志管理</span> &gt;&gt; 增加工作日志</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:title>
		<td class="caption"><strong>工作日志基本信息：(日志每天17:00后到次日的16:00前提交不会逾期,周六周日不计)</strong></td>
	</p:title>
	...
	<p:subBody width="98%">
		<p:table cells="1">
			<p:cell title="工作日期"><p:plugin name="workDate"/></p:cell>
