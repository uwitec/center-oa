...
public class PageLink extends BodyTagCenterSupport
{
    ...
    private void writePageLine(StringBuffer buffer)
    {
        ...
        buffer.append("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=GBK\" />").append(
            line);
        ...
        if (this.guid)
        {
            String guidStyle = request.getContextPath() + TagLibConstant.CSS_FOLDER_NAME
                               + "flexigrid/" + TagLibConstant.CSS_GUID_NAME;

            buffer.append("<link href='" + guidStyle + "' type=text/css rel=stylesheet>").append(
                line);
        }

        if (this.link)
        {
            buffer.append("<link href='" + cssStyle + "' type=text/css rel=stylesheet>").append(
                line);
        }
        ...
        if (this.dialog)
        {
            buffer.append(
                "<link href='" + request.getContextPath()
                    + "/js/plugin/dialog/css/dialog.css' type=text/css rel=stylesheet>").append(
                line);
        }
        ...
        if (cal)
        {
            buffer.append(
                "<link rel=stylesheet type='text/css' href='" + request.getContextPath()
                    ...
                    + "skins/aqua/theme.css'/>").append(line);
        ...
        if (this.guid)
        {
            buffer.append(
                "<script type=\"text/javascript\" src=\"" + request.getContextPath()
                    + TagLibConstant.JS_FOLDER_NAME + TagLibConstant.JQUERY_JS_LANG_FOLDER_NAME
                    + TagLibConstant.JS_QUERY_NAME + "\"></script>").append(line);
            // + "calendar_debug.js\"></script>").append(line);

            buffer.append(
                "<script type=\"text/javascript\" src=\"" + request.getContextPath()
                    + TagLibConstant.JS_FOLDER_NAME + TagLibConstant.JS_FLEXIGRID_NAME
                    + "\"></script>").append(line);
        }
        ...
        if (this.dialog)
        {
            buffer.append(
                "<script type=\"text/javascript\" src='" + request.getContextPath()
                    + "/js/json.js'></script>").append(line);
            buffer.append(
                "<script type=\"text/javascript\" src='" + request.getContextPath()
                    + "/js/cnchina.js'></script>").append(line);
            buffer.append(
                "<script type=\"text/javascript\" src='" + request.getContextPath()
                    + "/js/plugin/dialog/jquery.dialog.js'></script>").append(line);
            buffer.append(
                "<script type=\"text/javascript\" src='" + request.getContextPath()
                    + "/js/adapter.js'></script>").append(line);
        }
