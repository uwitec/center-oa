...
public class CityConfigAction extends DispatchAction
{
     ...
     */
    public ActionForward queryCityConfig(ActionMapping mapping,
            ...
            HttpServletResponse response) throws ServletException
    {
        ...
        ActionTools.processJSONQueryCondition(QUERYCITYCONFIG,
                request,
                condtion);
        
        String jsonstr = ActionTools.queryVOByJSONAndToString(QUERYCITYCONFIG,
                request,
                condtion,
                this.cityConfigDAO);
            ...
            throws ServletException
    {
        ...
        String jsonstr = ActionTools.queryVOByJSONAndToString(QUERYPROFIT,
                request,
                condtion,
                this.profitDAO);
     ...
     * @throws ServletException
     */
    public ActionForward queryCityProfit(ActionMapping mapping,
            ActionForm form, HttpServletRequest request,
            HttpServletResponse response) throws ServletException
    {
        ...
        String jsonstr = ActionTools.querySelfBeanByJSONAndToString(QUERYCITYPROFIT,
                request,
                condtion,
                new CommonQuery()
                {
            ...
            throws ServletException
    {
        ...
        String jsonstr = ActionTools.queryVOByJSONAndToString(QUERYCITYSAIL,
                request,
                condtion,
                this.citySailDAO);
     ...
     * @throws ServletException
     */
    public ActionForward listCitySail(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response)
            throws ServletException
    {
        AjaxResult ajax = new AjaxResult();
        
        List<CitySailBean> listEntityBeans = citySailDAO.listEntityBeans();
     ...
     * @throws ServletException
     */
    public ActionForward updateCityConfig(ActionMapping mapping,
            ActionForm form, HttpServletRequest request,
            HttpServletResponse response) throws ServletException
    {
        ...
        catch (MYException e)
        {
            ...
            request.setAttribute(KeyConstant.ERROR_MESSAGE, "修改失败:"
                    + e.getMessage());
        }
     ...
     * @throws ServletException
     */
    public ActionForward updateCityConfigSail(ActionMapping mapping,
            ActionForm form, HttpServletRequest request,
            HttpServletResponse response) throws ServletException
    {
        String id = request.getParameter("id");
        ...
        CityConfigBean cityConfig = cityConfigDAO.find(id);
        
        AjaxResult ajax = new AjaxResult();
        
        if (cityConfig == null)
        {
            ajax.setError("区域配置不存在");
            
            return JSONTools.writeResponse(response, ajax);
        }
        
        cityConfig.setBespread(sailId);
        
        try
        {
            User user = Helper.getUser(request);
            
            examineFacade.updateCityConfig(user.getId(), cityConfig);
            
            ajax.setSuccess("成功修改地市产品铺样");
        }
        catch (MYException e)
        {
            _logger.warn(e, e);
     ...
     * @throws ServletException
     */
    public ActionForward updateCityProfit(ActionMapping mapping,
            ActionForm form, HttpServletRequest request,
            HttpServletResponse response) throws ServletException
    {
     ...
     * @throws ServletException
     */
    public ActionForward updateCityProfitByToatl(ActionMapping mapping,
            ActionForm form, HttpServletRequest request,
            HttpServletResponse response) throws ServletException
    {
        ...
        try
        {
            ...
            examineFacade.updateCityProfitByTotal(user.getId(),
                    cityId,
     ...
     * @param currentNumber
     */
    private boolean innerAdd(User user, StringBuilder builder, String[] obj,
            int currentNumber)
    {
        boolean addSucess = false;
        try
     ...
     * @throws MYException
     */
    private ProfitBean createProfitBean(String[] obj) throws MYException
    {
        ...
        {
            throw new MYException("客户[%s]对应的职员是%s,工号%s,不是%s", cb.getCode(),
                    sb.getName(), sb.getCode(), code);
        }
            ...
            throws ServletException
    {
        ...
        try
        {
            ...
            int count = examineFacade.delProfitByYearAndMonth(user.getId(),
                    CommonTools.parseInt(year),
                    CommonTools.parseInt(month));
