 ...
 * @author ZHUZHU
 * @version 2009-2-14
 * @see ProductCityExamineItemBean
 * @since 1.0
 */
@Entity
@Table(name = "T_CENTER_PRODUCTSTAFFER")
public class ProductCityExamineItemBean implements Serializable
{
    @Id
    private String id = "";
    ...
    public ProductCityExamineItemBean()
    {}
