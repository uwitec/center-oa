...
public class CreditItemSecVO extends CreditItemSecBean
{
    ...
    public String toString()
    {
        ...
        retValue.append("CreditItemSecVO ( ").append(super.toString()).append(tab).append(
            "pName = ").append(this.pName).append(tab).append("parentPer = ").append(
            this.parentPer).append(tab).append("parentType = ").append(this.parentType).append(tab).append(
            "point = ").append(this.point).append(tab).append(" )");
