...
public class CreditItemSecBean implements Serializable
{
    ...
    public String toString()
    {
        ...
        retValue.append("CreditItemSecBean ( ").append(super.toString()).append(tab).append(
            "id = ").append(this.id).append(tab).append("pid = ").append(this.pid).append(tab).append(
            "name = ").append(this.name).append(tab).append("type = ").append(this.type).append(
            tab).append("face = ").append(this.face).append(tab).append("unit = ").append(
