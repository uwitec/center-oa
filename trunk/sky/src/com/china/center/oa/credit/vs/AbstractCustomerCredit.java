...
public abstract class AbstractCustomerCredit implements Serializable
{
    ...
    public String toString()
    {
        ...
        retValue.append("AbstractCustomerCredit ( ").append(super.toString()).append(tab).append(
            "id = ").append(this.id).append(tab).append("cid = ").append(this.cid).append(tab).append(
            "itemId = ").append(this.itemId).append(tab).append("pitemId = ").append(this.pitemId).append(
            tab).append("valueId = ").append(this.valueId).append(tab).append("ptype = ").append(
            this.ptype).append(tab).append("val = ").append(this.val).append(tab).append(
            "logTime = ").append(this.logTime).append(tab).append("log = ").append(this.log).append(
            tab).append(" )");
