 ...
 * @author zhuzhu
 * @version 2009-5-3
 * @see StafferHandlerPluginImpl
 * @since 1.0
 */
@Exceptional
@Bean(name = "stafferHandlerPluginImpl")
public class StafferHandlerPluginImpl extends AbstractHandlerPlugin implements HandlerPlugin
{
     ...
     * default constructor
     */
    public StafferHandlerPluginImpl()
    {}
    ...
    public List<StafferBean> listNextHandler(String nextTokenId)
    {
        ...
        List<TokenVSHanderBean> listVS = tokenVSHanderDAO.queryTokenVSHanderByTokenIdAndType(
            nextTokenId, getType());
