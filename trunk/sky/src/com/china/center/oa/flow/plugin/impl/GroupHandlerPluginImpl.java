 ...
 * @author zhuzhu
 * @version 2009-5-3
 * @see GroupHandlerPluginImpl
 * @since 1.0
 */
@Exceptional
@Bean(name = "groupHandlerPluginImpl")
public class GroupHandlerPluginImpl extends AbstractHandlerPlugin implements HandlerPlugin
{
