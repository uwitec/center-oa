...
{
	if (getRadioValue("fullId") != '')
	document.location.href = '../admin/out.do?method=findOut&fow=5&outId=' + getRadioValue("fullId");
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1'>
					...
					<tr class="content2">
						...
						<c:if test="${ff}">
						<select name="status" class="select_class" values="${requestScope.status}">
							<option value="">--</option>
					...
					<tr class="content1">
						<td width="15%" align="center">处理调入</td>
						<td width="15%" align="center">
						<select name="proIn" values="${proIn}"
							class="select_class">
							<option value="0">不处理</option>
							<option value="1">处理</option>
							<option value="2">物流中心在途查看</option>
							</select>
						</td>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="10">
							<tr>
								...
								<td width="6"><img src="../images/dot_r.gif" width="6"
									height="6"></td>
								<td class="caption"><strong>浏览${fg}单:</strong><font color=blue>[查询数量:${TATOL}]</font></td>
							</tr>
						</table>
						</td>
					</tr>
				...
				<table width="100%" border="0" cellspacing='1'>
					...
					<c:forEach items="${listOut1}" var="item" varStatus="vs">
						...
						>
							...
							<c:if test="${ff}">
							<td align="center" onclick="hrefAndSelect(this)">${my:get('outType', item.outType)}</td>
							</c:if>
	...
	<c:if test="${my:length(listOut1) >= 0 && user.role != 'THR'}">
	<tr>
		<td width="100%">
		<div align="right">
		...
		<c:if test="${adm}">
		<input type="button"
			class="button_class" onclick="processInvoke()"
			value="&nbsp;&nbsp;处理调出&nbsp;&nbsp;">&nbsp;&nbsp;
		<input type="button"
