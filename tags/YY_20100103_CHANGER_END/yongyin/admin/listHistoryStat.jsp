	...
	<tr>
		...
		<table width="100%" height="22" border="0" cellpadding="0"
			...
			<tr valign="middle">
				...
				<td width="550" class="navigation">资金日报 &gt;&gt; 历史记录</td>
				<td width="85"></td>
			</tr>
		</table>
		</td>
...
<table width="85%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1' id="result">
					<tr align="center" class="content0">
						...
						<td align="center" onclick="tableSort(this)" class="td_class"><strong>结算月</strong></td>
				...
				<table width="100%" border="0" cellspacing='1'>
					<tr align="right" class="content3">
						<td colspan="6"><input type="button" id="preButton"
							style="cursor: hand" value="&nbsp;上一页&nbsp;" class="button_class"
							...
							value="&nbsp;下一页&nbsp;" class="button_class" onclick="nextPage()"></td>
					</tr>
				</table>
				</td>
			</tr>
	...
	<tr>
		...
		<div align="right"><input name="add" type="button"
			class="button_class" value="&nbsp;本月月结&nbsp;" onclick="callbacks()"></div>
		</td>
		<td width="8%"></td>
	</tr>
