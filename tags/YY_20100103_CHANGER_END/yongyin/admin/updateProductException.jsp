...
<form name="addApply" action="../admin/proException.do" method="post">
<input type="hidden" name="method" value="updateProctException">
<input type="hidden" name="id" value="${bean.id}"> <p:navigation
	height="22">
	<td width="550" class="navigation"><span style="cursor: hand"
		onclick="javascript:history.go(-1)">货物异常处理管理</span> &gt;&gt; 修改货物异常处理</td>
	<td width="85"></td>
</p:navigation> <br>
