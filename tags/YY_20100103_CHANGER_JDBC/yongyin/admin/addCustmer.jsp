...
<form name="custmoer" action="./common.do"><input type="hidden"
	name="method" value="addCustmer"> <input type="hidden"
		...
		<table width="65%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1'>
					...
					<tr class="content2">
						<td width="30%">客户编码:</td>
						<td><input type="text" name="code" value="" maxlength="16"
							oncheck="notNone;"><font color="#FF0000">*</font></td>
					</tr>

					<tr class="content1">
						<td width="30%">所属职员:</td>
						<td><select name="stafferName" oncheck="notNone;"
							class="select_class">
							<option value=""}>--</option>
					...
					<tr class="content2">
						<td width="30%">联系人:</td>
						<td><input type="text" name="connector" value=""
							maxlength="16"></td>
					</tr>

					<tr class="content1">
						<td width="30%">联系电话:</td>
						<td><input type="text" name="phone" value="" maxlength="16"></td>
					</tr>
					
					<tr class="content2">
						<td width="30%">地址:</td>
						<td><input type="text" name="address" value="" maxlength="100"></td>
					</tr>
				</table>
				</td>
			</tr>
