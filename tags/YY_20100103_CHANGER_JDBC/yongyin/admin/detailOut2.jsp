...
<table width="80%" border="0" cellpadding="0" cellspacing="0"
		...
		<table width="85%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1'>
					...
					<tr class="content1">
						<td>${ff}单核对：</td>
						<td colspan="3"><textarea rows="3" cols="55" name="checks"
							oncheck="notNone">${out.checks}</textarea><font color="blue">(请填写)</font></td>
					</tr>
				</table>
				</td>
			</tr>
	...
	<tr>
		<td width="92%">
		<div align="right"><input type="button" class="button_class" name="subs"
			onclick="sub()" value="&nbsp;&nbsp;提交核对&nbsp;&nbsp;">&nbsp;&nbsp;<input
