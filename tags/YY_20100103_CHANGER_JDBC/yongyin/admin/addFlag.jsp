...
<form name="modifyPassword" action="./checkuser.do"><input
	type="hidden" name="method" value="addFlag">
	...
	<tr>
		...
		<table width="100%" height="22" border="0" cellpadding="0"
			...
			<tr valign="middle">
				...
				<td width="550" class="navigation">增加标志</td>
				<td width="85"></td>
			</tr>
		</table>
		</td>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="10">
							<tr>
								...
								<td width="6"><img src="../images/dot_r.gif" width="6"
									height="6"></td>
								<td class="caption"><strong>标记信息:</strong></td>
							</tr>
						</table>
						</td>
					</tr>
		...
		<table width="65%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1'>
					<tr class="content2">
						<td width="30%">全局标志:</td>
						<td><input type="text" name="flags" maxlength="4" oncheck="notNone"><font
