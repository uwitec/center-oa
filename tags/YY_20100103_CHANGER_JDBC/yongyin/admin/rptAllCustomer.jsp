...
<form action="./out.do" name="adminForm"><input type="hidden"
	value="queryAllCustomer" name="method"> 
	...
	<tr>
		...
		<table width="100%" height="22" border="0" cellpadding="0"
			...
			<tr valign="middle">
				...
				<td width="550" class="navigation">客户列表</td>
				<td width="85"></td>
			</tr>
		</table>
		</td>
		...
		<table width="85%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1'>
					...
					<tr class="content2">
						<td colspan="4" align="right"><input type="button" id="qu_b"
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="10">
							<tr>
								...
								<td width="6"><img src="../images/dot_r.gif" width="6"
									height="6"></td>
								<td class="caption"><strong>浏览客户:<font color=blue>[当前查询数量:${my:length(customerList)}]</font> 注意:系统仅提供符合条件的前50个客户</strong></td>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1'>
					<tr align="center" class="content0">
						...
						<td align="center" onclick="tableSort(this)" class="td_class">客户名称</td>
						<td align="center" onclick="tableSort(this)" class="td_class">客户编码</td>
						<td align="center" onclick="tableSort(this)" class="td_class">职员</td>
