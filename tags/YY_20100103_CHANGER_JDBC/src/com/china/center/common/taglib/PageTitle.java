...
public class PageTitle extends BodyTagCenterSupport
{
    ...
    private void writePageStart(StringBuffer buffer)
    {
        ...
        buffer.append("<table width='100%' border='0' cellpadding='0' cellspacing='0'>").append(
            line);
        buffer.append(
            "<tr><td width='784' height='6'></td></tr><tr><td align='center' valign='top'>").append(
            line);
        buffer.append("<div align='left'><table width='90%' border='0' cellspacing='2'>").append(
            line);
        buffer.append("<tr><td><table width='100%' border='0' cellpadding='0' cellspacing='10'>").append(
            line);
        buffer.append("<tr><td width='35'>&nbsp;</td><td width='6'>").append(line);
        buffer.append("<img src='" + this.url + "dot_r.gif' width='6' height='6'></td>").append(
            line);
    }
    ...
    {
        String line = "\r\n";
        buffer.append("</tr></table></td></tr></table></div></td></tr></table></td></tr>").append(
            line);
    }
}
