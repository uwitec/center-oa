...
<html>
<head>
<c:set  var="dis" value='${param.type eq "4" ? "人员" : "部门" }'/>
<p:link title="系统操作" />
...
<form name="addCommonFrom" action="../admin/common.do"><input
	type="hidden" name="method" value="addCommon">
	<input
...
<table width="85%" border="0" cellpadding="0" cellspacing="0"
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="10">
							<tr>
								...
								<td width="6"><img src="../images/dot_r.gif" width="6"
									height="6"></td>
								<td class="caption"><strong>${dis}信息:</strong></td>
							</tr>
						</table>
						</td>
					</tr>
		...
		<table width="65%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1'>
					<tr class="content2">
						<td width="30%">${dis}名称:</td>
						<td><input type="text" name="name" maxlength="16"><font
	...
	<tr>
		...
		<div align="right"><input name="add" type="button"
			...
			class="button_class" onclick="goProduct()"
			value="&nbsp;&nbsp;返 回&nbsp;&nbsp;"></div>
		</td>
		<td width="18%"></td>
	</tr>
