...
{
	window.common.modal("./out.do?method=queryProvider&flagg=${out.type}");
}
...
function checkTotal()
{
	...
	buffalo.remoteCall("productDAO.check",[ids, amous, ${out.type},locationId], function(reply) {	
		...
		<table width="100%" height="22" border="0" cellpadding="0"
			...
			<tr valign="middle">
				...
				<td width="550" class="navigation">库单管理 &gt;&gt; <span
					style="cursor:hand" onclick="javascript:history.go(-1)">查询入库单</span>
				&gt;&gt; 修改入库单</td>
				<td width="85"></td>
			</tr>
		</table>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="10">
							<tr>
								...
								<td width="6"><img src="../images/dot_r.gif" width="6"
									height="6"></td>
								<td class="caption"><strong>修改入库单信息:</strong>
								</td>
							</tr>
						</table>
						</td>
				...
				<table width="100%" border="0" cellspacing='1'>
					...
					<tr class="content2">
						...
						<td><input type="text" name="tranNo" maxlength="40"
							value="${out.tranNo}" oncheck="notNone"><font color="#FF0000">*</font></td>
						<td align="right"></td>
						<td></td>
					</tr>
					...
					<tr class="content2"> 
						...
						<td colspan="1"><select name="depotpartId" class="select_class" values="${out.depotpartId}" style="width: 240px"> 
								<option value=''>--</option>
