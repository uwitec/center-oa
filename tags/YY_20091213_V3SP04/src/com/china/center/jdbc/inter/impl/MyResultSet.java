...
public class MyResultSet implements ResultSet
{
     ...
     * 默认构建器
     */
    public MyResultSet(ResultSet resultSet, Convert convertEncode)
    {
    ...
    public String getString(String columnName, boolean decode)
        throws SQLException
    {
        String temp = null;
        ...
        if (decode)
        {
            temp = convertEncode.decode(resultSet.getString(encodeString(columnName)));
        }
        else
        {
    ...
    public String getString(int columnIndex, boolean decode)
        throws SQLException
    {
        if (decode)
        {
            return convertEncode.decode(resultSet.getString(columnIndex));
        }
        else
        {
    ...
    public int getInt(String columnName)
        throws SQLException
    {
        return resultSet.getInt(encodeString(columnName));
    }
    ...
    public long getLong(String columnName)
        throws SQLException
    {
        return resultSet.getLong(encodeString(columnName));
    }
    ...
    public double getDouble(String columnName)
        throws SQLException
    {
        return resultSet.getDouble(encodeString(columnName));
    }
    ...
    public short getShort(String columnName)
        throws SQLException
    {
        return resultSet.getShort(encodeString(columnName));
    }
    ...
    public float getFloat(String columnName)
        throws SQLException
    {
        return resultSet.getFloat(encodeString(columnName));
    }
    ...
    public byte getByte(String columnName)
        throws SQLException
    {
        return resultSet.getByte(encodeString(columnName));
    }
    ...
    public java.sql.Date getDate(String columnName)
        throws SQLException
    {
        return resultSet.getDate(encodeString(columnName));
    }
    ...
    public java.sql.Time getTime(String columnName)
        throws SQLException
    {
        return resultSet.getTime(encodeString(columnName));
    }
    ...
    public java.sql.Timestamp getTimestamp(String columnName)
        throws SQLException
    {
        return resultSet.getTimestamp(encodeString(columnName));
    }
    ...
    private String encodeString(String columnName)
    {
        return convertEncode.encode(columnName);
    }
    ...
    public BigDecimal getBigDecimal(int columnIndex, int scale)
        throws SQLException
    {
        throw new NoSuchMethodError("the method is deprecated by interface!");
    ...
    public void updateString(int columnIndex, String x)
        throws SQLException
    {
        resultSet.updateString(columnIndex, encodeString(x));
    }

    public void updateString(String columnName, String x)
        throws SQLException
    {
        resultSet.updateString(columnName, encodeString(x));
    }
