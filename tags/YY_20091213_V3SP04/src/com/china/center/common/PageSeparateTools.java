 ...
 * @since
 */
public class PageSeparateTools
{
    ...
    {
        Map<String, Object> parameterMap = CommonTools.saveParamersToMap(request);
        ...
        while (enums.hasMoreElements())
        {
            ...
            {
                parameterMap.put(name.substring(PAREXT.length()), request.getAttribute(name));
            }
        }
    }
