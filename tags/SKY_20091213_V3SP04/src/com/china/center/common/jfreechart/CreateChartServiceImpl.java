package com.china.center.common.jfreechart;
...
public class CreateChartServiceImpl
{
    ...
    public CreateChartServiceImpl(String rootPath)
    {
    ...
    public static void main(String[] args)
    {
        ...
        CreateChartServiceImpl pm = new CreateChartServiceImpl("E:/test/");
        // 生成饼状图
        pm.makePieChart();
        // 生成单组柱状图
        pm.makeBarChart();
    ...
    public void makeBarChart()
    {
        ...
        String[] columnKeys = {"北京", "上海", "广州", "成都", "深圳"};
        CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
        createBarChart(dataset, "分公司", "客户数", "单注", "bar.png");
    }
    ...
    {
        // 默认width为900
        return createBarChart(dataset, xName, yName, chartTitle, charName, 900);
    }
     ...
     */
    public String createBarChart(CategoryDataset dataset, String xName, String yName,
                                 String chartTitle, String charName, int width)
    {
        ...
        domainAxis.setMaximumCategoryLabelWidthRatio(1.6f);// 横轴上的 Lable 是否完整显示
        ...
        try
        {
            isChartPathExist(rootPath);
            String chartName = rootPath + charName;
            fos_jpg = new FileOutputStream(chartName);
            ChartUtilities.writeChartAsPNG(fos_jpg, chart, width, 500, true, 10);
            return chartName;
        }
        catch (Exception e)
        {
                                   ...
                                   CategoryDataset xyDataset, String charName)
    {
        ...
        JFreeChart chart = ChartFactory.createLineChart(chartTitle, x, y, xyDataset,
