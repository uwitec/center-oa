...
public class CreditCoreBean implements Serializable
{
    ...
    public String toString()
    {
        ...
        retValue.append("CreditCoreBean ( ").append(super.toString()).append(tab).append("id = ").append(
            this.id).append(tab).append("cid = ").append(this.cid).append(tab).append(
            "maxBusiness = ").append(this.maxBusiness).append(tab).append("sumTotal = ").append(
            this.sumTotal).append(tab).append("year = ").append(this.year).append(tab).append(" )");
