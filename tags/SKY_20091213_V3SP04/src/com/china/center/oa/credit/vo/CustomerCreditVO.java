...
public class CustomerCreditVO extends CustomerCreditBean
{
    ...
    public String toString()
    {
        ...
        retValue.append("CustomerCreditVO ( ").append(super.toString()).append(tab).append(
            "cname = ").append(this.cname).append(tab).append("itemName = ").append(this.itemName).append(
            tab).append("pitemName = ").append(this.pitemName).append(tab).append("valueName = ").append(
            this.valueName).append(tab).append(" )");
