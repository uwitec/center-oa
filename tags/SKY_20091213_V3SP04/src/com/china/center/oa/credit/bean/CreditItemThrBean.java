...
public class CreditItemThrBean implements Serializable
{
    ...
    public String toString()
    {
        ...
        retValue.append("CreditItemThrBean ( ").append(super.toString()).append(tab).append(
            "id = ").append(this.id).append(tab).append("pid = ").append(this.pid).append(tab).append(
            "name = ").append(this.name).append(tab).append("unit = ").append(this.unit).append(
            tab).append("indexPos = ").append(this.indexPos).append(tab).append("per = ").append(
