...
public class CustomerCheckAction extends DispatchAction
{
        ...
        throws ServletException
    {
        ...
        else
        {
            ...
            condtion.addIntCondition("CustomerCheckItemBean.status", "=",
                CommonConstant.STATUS_END);
        }
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            customerFacade.addCheckBean(user.getId(), bean);
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            customerFacade.goonBean(user.getId(), bean);
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            customerFacade.delCheckBean(user.getId(), id);
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            customerFacade.passCheckBean(user.getId(), id);
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            customerFacade.updateCheckItem(user.getId(), bean);
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            customerFacade.rejectCheckBean(user.getId(), id);
