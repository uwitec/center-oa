...
public class FlowAction extends DispatchAction
{
        ...
        throws ServletException
    {
        ...
        String jsonstr = ActionTools.queryVOByJSONAndToString(QUERYFLOWDEFINE, request, condtion,
            this.flowDefineDAO);
     ...
     * @throws ServletException
     */
    public ActionForward queryFlowDefine2(ActionMapping mapping, ActionForm form,
                                          HttpServletRequest request, HttpServletResponse response)
        throws ServletException
    {
        final ConditionParse condtion = new ConditionParse();
        ...
        String jsonstr = ActionTools.queryVOByJSONAndToString(QUERYFLOWDEFINE2, request, condtion,
            this.flowDefineDAO);
     ...
     * @throws ServletException
     */
    public ActionForward updateFlowDefine(ActionMapping mapping, ActionForm form,
                                          HttpServletRequest request, HttpServletResponse reponse)
        throws ServletException
    {
        FlowDefineBean bean = new FlowDefineBean();
     ...
     * @throws ServletException
     */
    public ActionForward deleteFlowDefine(ActionMapping mapping, ActionForm form,
                                          HttpServletRequest request, HttpServletResponse response)
        throws ServletException
    {
     ...
     * @throws ServletException
     */
    public ActionForward findFlowDefine(ActionMapping mapping, ActionForm form,
                                        HttpServletRequest request, HttpServletResponse response)
        throws ServletException
    {
     ...
     * @throws ServletException
     */
    public ActionForward preForConfigToken(ActionMapping mapping, ActionForm form,
                                           HttpServletRequest request, HttpServletResponse response)
        throws ServletException
    {
        CommonTools.saveParamers(request);
     ...
     * @throws ServletException
     */
    public ActionForward preForConfigView(ActionMapping mapping, ActionForm form,
                                          HttpServletRequest request, HttpServletResponse response)
        throws ServletException
    {
        String id = request.getParameter("id");
     ...
     * @throws ServletException
     */
    public ActionForward configToken(ActionMapping mapping, ActionForm form,
                                     HttpServletRequest request, HttpServletResponse response)
        throws ServletException
    {
        FlowDefineBean bean = new FlowDefineBean();
    ...
    private void setFlowToken(FlowDefineBean pbean, HttpServletRequest request)
    {
        ...
        for (int i = 0; i < providers.length; i++ )
        {
            ...
            if (tokenItem.getType() == FlowConstant.TOKEN_TYPE_REALTOKEN)
            {
                ...
                tokenItem.setPluginType(CommonTools.parseInt(request.getParameter("tokenType_"
                                                                                  + providers[i])));
     ...
     * @param tokenItem
     */
    private void createTokenBaseInfo(FlowDefineBean pbean, HttpServletRequest request,
                                     String[] providers, int orders, int i, FlowTokenBean tokenItem)
    {
        tokenItem.setFlowId(pbean.getId());

        // set token type
        tokenItem.setType(CommonTools.parseInt(request.getParameter("tokenSelfType_"
                                                                    + providers[i])));
     ...
     * @param tokenItem
     */
    private void setTemplateOperation(HttpServletRequest request,
                                      List<FlowVSTemplateBean> templates, int i,
