...
public abstract class SMSHelper
{
    ...
    public static boolean sendSMSReal(String format, String phone, String content,
                                      String messageFlag, String exNumber)
    {
        ...
        String url = formatter.format(format.trim(), phone.trim(), content.trim(), messageFlag,
            exNumber).toString();
