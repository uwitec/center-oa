...
function load()
{
     ...
     guidMap = {
         ...
         colModel : [
             ...
             {display: '环数', name : 'token', content: '第{status}环', width : '10%', toFixed: 2},
             ...
             {display: '申请时间', name : 'logTime', sortable : true, cname: 'logTime',  width : 'auto'}
             ],
         extAtt: {
...
function $callBack()
{
    ...
    highlights($("#mainTable").get(0), ['结束', '业务员'], 'blue');
}
