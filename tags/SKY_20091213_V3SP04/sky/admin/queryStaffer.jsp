...
function load()
{
	 guidMap = {
		 ...
		 colModel : [
		     ...
		     {display: '部门', name : 'departmentName', cname : 'departmentId', width : '15%', sortable : true, align: 'left'},
		     {display: '岗位', name : 'principalshipName', width : '12%', sortable : false, align: 'left'},
...
function $callBack()
{
    ...
    $.highlight($("#mainTable").get(0), '设置', 'blue');
    
    $.highlight($("#mainTable").get(0), '未设置', 'red');
}
