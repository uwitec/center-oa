...
<p:body width="100%">
	...
	<p:title>
		<td class="caption"><strong>合成产品</strong>【从良品仓出入的产品会同步到库存中】</td>
	</p:title>
	...
	<p:subBody width="98%">
		<p:table cells="1">
			...
			目的产品：<input type="text" style="width: 20%;cursor: pointer;" readonly="readonly" value="" oncheck="notNone" name="dirTargerName" 
