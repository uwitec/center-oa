...
public class InstanceTemplateBean implements Serializable
{
    @Id
    private String id = "";
    ...
    public String toString()
    {
        ...
        retValue.append("InstanceTemplateBean ( ").append(super.toString()).append(tab).append(
            "id = ").append(this.id).append(tab).append("name = ").append(this.name).append(tab).append(
            "instanceId = ").append(this.instanceId).append(tab).append("templateId = ").append(
            this.templateId).append(tab).append("flowId = ").append(this.flowId).append(tab).append(
            "path = ").append(this.path).append(tab).append("logTime = ").append(this.logTime).append(
            tab).append("readonly = ").append(this.readonly).append(tab).append(" )");
