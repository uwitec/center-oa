...
public class NoteManager
{
    ...
    public boolean addReceiveTask(ReceiveTaskBean task)
        throws MYException
    {
        task.setId(commonDAO2.getSquenceString20());
    ...
    public void synReceiveToSend()
    {
        ...
        for (ReceiveTaskBean receiveTaskBean : receiveList)
        {
            ...
            ShortMessageTaskBean task = shortMessageTaskDAO.findByReceiverAndHandId(
                receiveTaskBean.getSender(), splitStr[0]);
