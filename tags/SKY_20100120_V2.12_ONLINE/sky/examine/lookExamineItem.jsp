...
<ul>
	...
	<c:if test="${bean.attType == 2}">
	<li><a href="#fragment-4"><span>区域客户成交</span></a></li>
	</c:if>
</ul>
<c:if test="${bean.attType == 2}">
<div id="fragment-1"><IFRAME height="100%"
	src="../examine/examine.do?method=queryNewCustomerExamine&pid=${bean.id}&look=1"
	id="ifr1" frameborder="0" width="100%" scrolling="auto"></IFRAME></div>
<div id="fragment-2"><IFRAME height="100%"
	src="../examine/examine.do?method=queryOldCustomerExamine&pid=${bean.id}&look=1"
	id="ifr2" frameborder="0" width="100%"
	scrolling="auto"></IFRAME></div>
</c:if>
<div id="fragment-3"><IFRAME height="100%"
	src="../examine/examine.do?method=queryProfitExamine&pid=${bean.id}&look=1"
	id="ifr3" frameborder="0" width="100%"
	scrolling="auto"></IFRAME></div>
<c:if test="${bean.attType == 2}">
<div id="fragment-4"><IFRAME height="100%"
	src="../examine/examine.do?method=queryCityProfitExamine&pid=${bean.id}&look=1"
