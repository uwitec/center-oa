...
function doSearch()
{
    window.common.qmodal('../admin/query.do?method=popCommonQuery&key=queryBudget');
}

function doSearch1()
{
    window.common.qmodal('../admin/query.do?method=popCommonQuery&key=queryBudget&name=queryRunBudget');
}
