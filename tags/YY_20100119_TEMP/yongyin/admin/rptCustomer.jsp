...
<form action="./out.do" name="adminForm"><input type="hidden"
	value="queryCustomer" name="method"> <input type="hidden"
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="10">
							<tr>
								...
								<td width="6"><img src="../images/dot_r.gif" width="6"
									height="6"></td>
								<td class="caption"><strong>浏览客户:<font color=blue>[当前查询数量:${my:length(customerList)}]</font> 注意:系统仅提供符合条件的前100个客户</strong></td>
