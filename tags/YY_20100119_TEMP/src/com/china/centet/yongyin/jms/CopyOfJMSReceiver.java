 ...
 * @since
 */
public class CopyOfJMSReceiver
{
        ...
        public void run()
        {
            while (true)
            {
                try
                {
                    ...
                    if (msg != null)
                    {
                        System.out.println("CopyOfJMSReceiver sub1 Received -->"
                                           + textMessage.getText());
                    }

                    if (ii > 1800)
                    {
                        System.out.println("CopyOfJMSReceiver sub1 Received -->" + ii);
                    }
                }
                catch (Throwable e)
                {
        ...
        public void run()
        {
            while (true)
            {
                try
                {
                    ...
                    if (msg != null)
                    {
                        System.out.println("--------------CopyOfJMSReceiver queue1 Received -->"
                                           + textMessage.getText());
                    }
                }
                catch (Throwable e)
